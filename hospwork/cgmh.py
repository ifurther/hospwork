...
class Cgmh(Hospital_work):
    def __init__(self):
        ...
        self.pages = self.self.work_page_base.find_all('ul' ,class_="layout__pagination ul-reset")[0]
        ...
        for _page in range(1,self.get_pages(self.pages)+1):
            ...
            self.get_work_table(soup_,tables,work_table)
    ...
    def get_work_table(self,soup,tables,work_table):
