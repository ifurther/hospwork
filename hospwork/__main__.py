...
def main():
    csmpt, ylh, ntuh, vghks, hch, ntucc, vghtc, vghtpe, cgmh = Csmpt(), Ylh(), Ntuh(), Vghks(), Hch(), Ntucc(), Vghtc(), Vghtpe(), Cgmh()
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        for cc in [csmpt, ylh, ntuh, hch, ntucc, vghks, vghtc, vghtpe, cgmh]:
